...
module.exports = [
  ...
  {
    name: 'getRaffleActivity',
    method: 'post',
    url: `${URI}getRaffleActivity`,
    response: require('./getRaffleActivity'),
    description: '获取抽奖活动',
    delay: 0,
  },
  {
    name: 'getRaffleUserActivityPrize',
    method: 'post',
    url: `${URI}getRaffleUserActivityPrize`,
    response: require('./getRaffleUserActivityPrize'),
    description: '获取抽奖结果',
    delay: 0,
  },
  {
    name: 'getUserPrizeExchange',
    method: 'post',
    url: `${URI}getUserPrizeExchange`,
    response: require('./getUserPrizeExchange'),
    description: '接口领奖',
    delay: 0,
  },
  {
    name: 'getUserRaffle',
    method: 'post',
    url: `${URI}getUserRaffle`,
    response: require('./getUserRaffle'),
    description: '获取抽奖结果',
    delay: 0,
  },
  {
