...
const error = {
  ...
  response: {
                  ...
                  skuList: [
                    {
                      ...
                      params: {
                        flowBalance: 3,
                        skuImg:
                          'https://chaac.oss-cn-hangzhou.aliyuncs.com/metaValue/1021/sku/100002/20/100079/skuImg_173425786.png',
                      },
                      detailButton: { type: 3, title: '去领取', style: 1, orderId: null },
                    },
                  ],
                  ...
                  skuList: [
                    {
                      ...
                      params: {
                        flowBalance: 1,
                        skuImg:
                          'https://chaac.oss-cn-hangzhou.aliyuncs.com/metaValue/1021/sku/100003/20/100079/skuImg_173438872.png',
                      },
                      detailButton: { type: 3, title: '去领取', style: 1, orderId: null },
                    },
                  ],
                  ...
                  skuList: [
                    {
                      ...
                      params: {
                        flowBalance: 1,
                        skuImg:
                          'https://chaac.oss-cn-hangzhou.aliyuncs.com/metaValue/1021/sku/100004/20/100079/skuImg_173446330.png',
                      },
                      detailButton: { type: 3, title: '去领取', style: 1, orderId: null },
                    },
                  ],
    ...
    phoneNumber: '166****8582',
    nickName: null,
    avatar: null,
    memberJoinTitle: '2022年10月13日起生效，已享受1天',
    showDeductionType: 1,
    toBindUserUrl: 'https://litevip.jujienet.com/apsu-api-test/index/100078',
  },
};
